...
4. Creating A Deployment Of WordPress:4.8-apache Pod, Attaching the Volumes & Putting Database Details Using Environment     5.Variables.
6.Exposing WordPress Deployment with Service Type NodePort
